...
class _ExpenseViewState extends ConsumerState<ExpenseView> {
  ...
  List<DropdownMenuItem<ExpenseFilter>> dropitems = [
    DropdownMenuItem(value: ExpenseFilter.today, child: Text('Today')),
    DropdownMenuItem(value: ExpenseFilter.week, child: Text('This Week')),
    DropdownMenuItem(value: ExpenseFilter.month, child: Text('This Month')),
    DropdownMenuItem(value: ExpenseFilter.year, child: Text('This Year')),
    DropdownMenuItem(value: ExpenseFilter.alltime, child: Text('All Time')),
  ];
            ...
            Row(
              children: [
                ...
                DropdownButton<ExpenseFilter>(
                  ...
                  items: dropitems,
                  onChanged: (ExpenseFilter? filter) {
                    ref
